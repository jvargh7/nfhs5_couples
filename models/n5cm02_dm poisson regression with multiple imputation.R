...
source("models/n5cm_dm poisson regression equations.R")
...
bind_rows(
  ...
  write_csv(.,"models/n5cm02_dm poisson regression with multiple imputation.csv")
...
bind_rows(
  ...
  write_csv(.,"models/n5cm02_dm contrasts for poisson regression with multiple imputation.csv")
