...
source("models/n5cm_htn poisson regression equations.R")
...
bind_rows(
  ...
  write_csv(.,"models/n5cm01_htn poisson regression with multiple imputation.csv")
...
bind_rows(
  ...
  write_csv(.,"models/n5cm01_htn contrasts for poisson regression with multiple imputation.csv")
