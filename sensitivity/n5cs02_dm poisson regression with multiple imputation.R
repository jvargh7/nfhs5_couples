...
source("sensitivity/n5cs_dm poisson regression equations.R")
...
bind_rows(
  ...
  write_csv(.,"sensitivity/n5cs02_dm poisson regression with multiple imputation.csv")
...
contrasts_w6_out_rel2 = mice_contrasts_svyglm(svymodel_list = overall_w6,modifier = "religion_muslim",exposure = "h_dm")
contrasts_h6_out_rel2 = mice_contrasts_svyglm(svymodel_list = overall_h6,modifier="religion_muslim",exposure="w_dm")

contrasts_w6_out_rel3 = mice_contrasts_svyglm(svymodel_list = overall_w6,modifier = "religion_other",exposure = "h_dm")
contrasts_h6_out_rel3 = mice_contrasts_svyglm(svymodel_list = overall_h6,modifier="religion_other",exposure="w_dm")
...
bind_rows(
  ...
  write_csv(.,"sensitivity/n5cs02_dm contrasts for poisson regression with multiple imputation.csv")
