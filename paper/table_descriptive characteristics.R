...
summary_table <- bind_rows(
  read_csv("analysis/summary table of analytic sample.csv") %>% mutate(dataset = "Analytic"),
  read_csv("analysis/summary table of excluded sample.csv") %>% mutate(dataset = "Excluded")) %>%
