strata_associations <- read_csv(paste0(path_couples_folder,"/working/concordance/ipaw strata specific spousal status associations long.csv"))
india_associations <- read_csv(paste0(path_couples_folder,"/working/concordance/ipaw india association of partner status long.csv"))
library(ggpubr)
...
ggarrange(figA,
  ...
  ggsave(.,
         width = 10,height=6,
         filename=paste0(path_couples_folder,"/figures/ipaw strata specific associations.png"))
